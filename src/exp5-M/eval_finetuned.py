...
# ==============================================================
def evaluate_model(model, dataloader, device, num_classes, dataset_name="testset", backbone="efficientnetv2_m", results_dir=""):
    model.eval()
...
# ==============================================================
# MAIN — guarda en outputs/phase3/<backbone>/exp5/exports y genera ZIP externo
# ==============================================================
def main():
    cfg = load_config()
    ...
    results_dir = os.path.join(base_dir, "outputs", "phase3", backbone, "exp5", "exports")
    os.makedirs(results_dir, exist_ok=True)
    external_zip_dir = os.path.join(base_dir, "exports", backbone, "exp5", "exports")
    ...
    ckpt_path = os.path.join(base_dir, "outputs", "phase3", backbone, "exp5", "checkpoints", f"best_weights_{backbone}.pt")
