...
def process_backbone(backbone):
    if backbone == "mobilenetv3":
        input_dir = "outputs/phase3/mobilenetv3/exp3/exports"
        output_dir = "outputs/phase3/mobilenetv3/exp3/calibration"
    elif backbone == "efficientnetb0":
        input_dir = "outputs/phase3/efficientnetb0/exp3/exports"
        output_dir = "outputs/phase3/efficientnetb0/exp3/calibration"
    else:
        return
