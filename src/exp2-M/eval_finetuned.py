...
# ==============================================================
# MAIN (versión corregida: guarda en outputs/phase3/<backbone>/exp2/exports)
# ==============================================================
def main():
    cfg = load_config()
    ...
    # --- Directorio de exportación (ruta existente en tu estructura) ---
    results_dir = os.path.join(base_dir, "outputs", "phase3", backbone, "exp2", "exports")
    os.makedirs(results_dir, exist_ok=True)

    # --- Buscar checkpoint automáticamente ---
    ckpt_path = None
    ...
    print(f"[INFO] Checkpoint encontrado: {ckpt_path}")
    ...
    print(f"\n[INFO] Evaluación completada. Resultados guardados en {results_dir}")
