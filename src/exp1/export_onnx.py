...
def export_to_onnx(backbone="mobilenetv3"):
    ...
    cfg = load_config("configs/phase3.yaml")  # Usa el YAML correspondiente al experimento 1
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    num_classes = cfg["model"]["num_classes"]

    # Directorios específicos de EXP1
    if backbone == "mobilenetv3":
        ckpt_dir = "outputs/phase3/mobilenetv3/exp1/checkpoints"
        export_dir = "outputs/phase3/mobilenetv3/exp1/exports"
    elif backbone == "efficientnetb0":
        ckpt_dir = "outputs/phase3/efficientnetb0/exp1/checkpoints"
        export_dir = "outputs/phase3/efficientnetb0/exp1/exports"
    else:
    ...
    parent_dir = os.path.dirname(export_dir)  # -> outputs/phase3/mobilenetv3/exp1
